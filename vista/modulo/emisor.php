 ...
 <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="inicio.php" class="btn btn-primary btn-block margin-bottom">Volver a Mesa de Entrada</a>
            <!-- /.box-body -->
          </div>
          <!-- /. box -->
          ...
          <div class="box box-primary">
            ...
            <div class="box-footer">
              <div class="pull-right">
                <button type="button" class="btn btn-default"><i class="fa fa-pencil"></i> Borradores</button>
